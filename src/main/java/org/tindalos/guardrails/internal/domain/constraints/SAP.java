 ...
 * while unstable packages (those with few dependents) can be concrete. This guardrails creates a
 * balance between stability and flexibility in the codebase.</p>
 *
 * <p>The guardrails is measured using the relationship between:</p>
 * <ul>
