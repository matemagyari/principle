 ...
 */
public class PackageCohesionConstants {

    public static final String SECTION_LINE     = "================================================================================";
    public static final String SUB_SECTION_LINE = "-----------------------------------------------------------------------------";

    public static final String COHESIVE_GROUPS_FILE_NAME          = "identified_cohesive_groups.txt";
    public static final String PACKAGE_COHESIONS_FILE_NAME        = "existing_packages_cohesion.txt";
    public static final String PACKAGE_STRUCTURE_HINTS1_FILE_NAME = "code_structure_observations1.txt";
    public static final String PACKAGE_STRUCTURE_HINTS2_FILE_NAME = "code_structure_observations2.txt";
    ...
    public static final String GENERAL_DESCRIPTION =
            GRAPH_DESCRIPTION +
