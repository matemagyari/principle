...
import org.tindalos.principle.internal.domain.core.PackageStructureBuildingException;
...
public class PackageTest {
    ...
    public void testInsertIndirectSubPackage() {
        ...
        Assert.assertEquals(1, parent.subPackages().size());
        org.tindalos.principle.internal.domain.core.Package child = parent.subPackages().get(0);
    ...
    public void testToMap() {
        ...
        Map<PackageReference, org.tindalos.principle.internal.domain.core.Package> map = parent.toMap();
    ...
    public void testMultipleLevelInsertion() {
        ...
        org.tindalos.principle.internal.domain.core.Package org_example = root.subPackages().get(0);
        assertEquals("org.example", org_example.reference().name());

        assertEquals(1, org_example.subPackages().size());
        org.tindalos.principle.internal.domain.core.Package org_example_app = org_example.subPackages().get(0);
