error id: file://<WORKSPACE>/src/test/scala/org/tindalos/principle/domain/checker/ADPTest.scala:MyJDependRunner
...
class ADPTest {
  ...
  private def run(basePackage: String): util.Map[PackageReference, util.Set[Cycle]] = {
    ...
    val classes = M@@yJDependRunner.createNodesOfClasses(basePackage)
