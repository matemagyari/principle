error id: file://<WORKSPACE>/src/test/scala/org/tindalos/principle/domain/checker/ADPTest.scala:createNodesOfClasses
...
class ADPTest {
  ...
  private def run(basePackage: String): util.Map[PackageReference, util.Set[Cycle]] = {
    ...
    val classes = MyJDependRunner.createN@@odesOfClasses(basePackage)
