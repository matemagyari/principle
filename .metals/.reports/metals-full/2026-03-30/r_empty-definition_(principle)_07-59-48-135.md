...
non-local guesses:
	 -scala/collection/JavaConverters.sortedByAfferents.nonEmpty.
	 -scala/collection/JavaConverters.sortedByAfferents.nonEmpty#
	 -scala/collection/JavaConverters.sortedByAfferents.nonEmpty().
	 -sortedByAfferents/nonEmpty.
	 -sortedByAfferents/nonEmpty#
	 -sortedByAfferents/nonEmpty().
	 -scala/Predef.sortedByAfferents.nonEmpty.
	 -scala/Predef.sortedByAfferents.nonEmpty#
	 -scala/Predef.sortedByAfferents.nonEmpty().
offset: 1127
...
class CycleDetector(packageStructureBuilder: PackageStructureBuilder) extends Analyzer {
    ...
    override def analyze(input: AnalysisInput) = {
      ...
      while (sortedByAfferents.nonEmpt@@y) {
