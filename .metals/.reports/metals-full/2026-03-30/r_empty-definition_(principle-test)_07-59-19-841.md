...
non-local guesses:
	 -org/junit/packageListProducer/build.
	 -org/junit/packageListProducer/build#
	 -org/junit/packageListProducer/build().
	 -org/tindalos/principle/domain/analyzers/adp/packageListProducer/build.
	 -org/tindalos/principle/domain/analyzers/adp/packageListProducer/build#
	 -org/tindalos/principle/domain/analyzers/adp/packageListProducer/build().
	 -org/tindalos/principle/domain/constraints/packageListProducer/build.
	 -org/tindalos/principle/domain/constraints/packageListProducer/build#
	 -org/tindalos/principle/domain/constraints/packageListProducer/build().
	 -scala/collection/JavaConverters.packageListProducer.build.
	 -scala/collection/JavaConverters.packageListProducer.build#
	 -scala/collection/JavaConverters.packageListProducer.build().
	 -packageListProducer/build.
	 -packageListProducer/build#
	 -packageListProducer/build().
	 -scala/Predef.packageListProducer.build.
	 -scala/Predef.packageListProducer.build#
	 -scala/Predef.packageListProducer.build().
offset: 4124
...
class ADPTest {
  ...
  private def run(basePackage: String): util.Map[PackageReference, util.Set[Cycle]] = {
    ...
    val packageList = packageListProducer.bu@@ild()
