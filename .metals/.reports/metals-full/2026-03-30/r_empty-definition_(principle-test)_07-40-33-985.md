error id: file://<WORKSPACE>/src/test/scala/org/tindalos/principle/domain/checker/ADPTest.scala:JDependBasedPackageListBuilder
file://<WORKSPACE>/src/test/scala/org/tindalos/principle/domain/checker/ADPTest.scala
empty definition using pc, found symbol in pc: 
semanticdb not found

found definition using fallback; symbol JDependBasedPackageListBuilder
offset: 3895
...
class ADPTest {
  ...
  private def run(basePackage: String): util.Map[PackageReference, util.Set[Cycle]] = {
    init(basePackage)
    val packageListProducer = new JDe@@pendBasedPackageListBuilder(basePackage)
