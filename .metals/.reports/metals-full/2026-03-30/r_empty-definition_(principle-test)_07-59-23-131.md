...
non-local guesses:
	 -org/junit/Constraints.builder.
	 -org/junit/Constraints.builder#
	 -org/junit/Constraints.builder().
	 -org/tindalos/principle/domain/analyzers/adp/Constraints.builder.
	 -org/tindalos/principle/domain/analyzers/adp/Constraints.builder#
	 -org/tindalos/principle/domain/analyzers/adp/Constraints.builder().
	 -org/tindalos/principle/domain/constraints/Constraints.builder.
	 -org/tindalos/principle/domain/constraints/Constraints.builder#
	 -org/tindalos/principle/domain/constraints/Constraints.builder().
	 -scala/collection/JavaConverters.Constraints.builder.
	 -scala/collection/JavaConverters.Constraints.builder#
	 -scala/collection/JavaConverters.Constraints.builder().
	 -Constraints.builder.
	 -Constraints.builder#
	 -Constraints.builder().
	 -scala/Predef.Constraints.builder.
	 -scala/Predef.Constraints.builder#
	 -scala/Predef.Constraints.builder().
offset: 885
