...
import org.tindalos.guardrails.domain.analyzers.acd._
...
class ACDTest {
  ...
  def simple1() = {
    ...
    val result = run("org.tindalos.guardrailstest.acd.simple1")
  ...
  def simple11() {
    ...
    val result = run("org.tindalos.guardrailstest.acd.simple11")
  ...
  def simple() {
    ...
    val result = run("org.tindalos.guardrailstest.acd.simple")
  ...
  def cyclic3() {
    ...
    val result = run("org.tindalos.guardrailstest.acd.cyclic3")
  ...
  def cyclic6() {
    ...
    val result = run("org.tindalos.guardrailstest.acd.cycle6")
  ...
  def cyclic62() {
    ...
    val result = run("org.tindalos.guardrailstest.acd.cycle6_2")
