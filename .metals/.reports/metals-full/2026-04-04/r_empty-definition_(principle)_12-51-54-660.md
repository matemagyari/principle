...
non-local guesses:
	 -org/tindalos/principle/domain/analyzers/structure/buildAnalyzer.
	 -org/tindalos/principle/domain/analyzers/structure/buildAnalyzer#
	 -org/tindalos/principle/domain/analyzers/structure/buildAnalyzer().
	 -org/tindalos/principle/infrastructure/reporters/buildAnalyzer.
	 -org/tindalos/principle/infrastructure/reporters/buildAnalyzer#
	 -org/tindalos/principle/infrastructure/reporters/buildAnalyzer().
	 -scala/collection/JavaConverters.buildAnalyzer.
	 -scala/collection/JavaConverters.buildAnalyzer#
	 -scala/collection/JavaConverters.buildAnalyzer().
	 -buildAnalyzer.
	 -buildAnalyzer#
	 -buildAnalyzer().
	 -scala/Predef.buildAnalyzer.
	 -scala/Predef.buildAnalyzer#
	 -scala/Predef.buildAnalyzer().
offset: 1587
